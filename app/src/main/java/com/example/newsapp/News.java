...
public class News implements Serializable {
    ...
    public static List<News> loadStory() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            String imageURL = "https://dummyimage.com/400x400/8bedeb/080808&text=Top+Story+" + (i+1);
    ...
    public static List<News> loadNews() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            String details = "This is a sample description for news item number " + (i+1);
            String imageURL = "https://dummyimage.com/600x400/fa9837/080808&text=News+Image+" + (i+1);
            News news = new News(title, details, imageURL);
            newsList.add(news);
        }
        return newsList;
